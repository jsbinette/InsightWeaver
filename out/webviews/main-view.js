...
`;
  ...
  var answer = document.getElementById("answers-id");
  var instructions = document.getElementById("instructions-id");
  var chatQuestionTextArea = document.getElementById("question-text-id");
  var askButton = document.getElementById("ask-button-id");
  var asknoinstrButton = document.getElementById("ask-no-instructions-button-id");
  var clearButton = document.getElementById("clear-button-id");
  var showHistoryButton = document.getElementById("show-history-button");
  var clearHistoryButton = document.getElementById("clear-history-button");
  var showInstructionsButton = document.getElementById("show-instructions-button");
  var characterCount = document.getElementById("instructions-character-count");
  var askImageButton = document.getElementById("ask-image-button-id");
  var promptTextArea = document.getElementById("prompt-text-id");
  var clearImageButton = document.getElementById("clear-image-button-id");
  function main() {
    hideProgressRing();
  ...
  function handleShowHistoryButtonClick() {
    ...
    if (el2?.style.getPropertyValue("display") == "none")
  ...
  function onHistoryClicked(question) {
  ...
  function updateImageList(imageUrls) {
  ...
  function showProgressRing() {
    const progressRing = document.getElementById("progress-ring-id");
